...
C3.Plugins.Jammanna_MakeIt3D.Exps =
{
	...
	LastCreatedId()
	{
		return this._lastAddedObjectId;
	},
	LastDestroyedId() {
		return this._lastDestroyedObjectId;
	},
	...
	GetCurrentForeachObjectId() {
		if (!this._currentObject) {
			return null; // or 0, or -1 depending on your convention
		}
		return this._currentObject.objectId; // assuming your cached object has objectId property
	},
	GetErrorMsg()
	{
