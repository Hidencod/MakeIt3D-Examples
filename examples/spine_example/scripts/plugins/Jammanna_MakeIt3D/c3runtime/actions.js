...
C3.Plugins.Jammanna_MakeIt3D.Acts =
{
	...
	async AddSpineObject(objectId, skeltonJsonPath, atlasPath, basePath, skinName, position, rotation, scale, materialType,visible) {
		...
		await this._addSpineObject(
			{
				objectId, skeltonJsonPath, atlasPath, basePath, skinName, position, rotation, scale,materialType: material[materialType], visible
			}
		)
	},
